...
from skimage import io, filters, color, measure, util, morphology, transform
...
def export_result(dir, name, colored, contour):
    ...
    cv2.imwrite("{}/{}.jpg".format(dir, name), bgr)
    cv2.imwrite("{}/{}_contour.jpg".format(dir, name), 255*(1-contour))
